...
PyHandle is based on a prior development of the `EUDAT project <https://eudat.eu/>`_ under the name B2Handle.
As `B2Handle <https://github.com/EUDAT-B2SAFE/B2HANDLE/>`_ was developed with a specific scope - Handle operations in the EUDAT project - in mind, it has been improved and made more generic to cater to a broader audience.
